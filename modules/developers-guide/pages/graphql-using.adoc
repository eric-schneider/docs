...
xref:graphql-using.adoc#_creating_a_user-defined_type (UDT)[user-defined type (UDT)].
...
Use the xref:auth.adoc[application token] you generated
...
----
include::example$graphql/createIndexes.graphql[]
----
--
...
[source,shell,subs="attributes+"]
----
include::example$graphql/curl_createIndexes.sh[]
----
--
Result::
+
...
[source,shell,subs="attributes+"]
----
include::example$graphql/deleteIndex.graphql[]
----
--
...
[source,shell,subs="attributes+"]
----
include::example$graphql/curl_deleteIndex.sh[]
----
--
...
htts://localhost:8080/graphql/library[http://localhost:8080/graphql/library]
